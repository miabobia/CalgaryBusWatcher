...
- create file that:
    ...
    - use gtfs_realtime_pb2.py to generate bus info
    - use CT_GTFS files to get translate necessary bus info
    - update db with bus info (locking mechanism to make sure we aren't reading/writing at same time???)
